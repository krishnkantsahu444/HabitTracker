...
module.exports.toggleStatus = async function(req, res) {
    try {
        ...
        if (index !== -1) {
            if(dates[index].complete === 'y'){
                dates[index].complete = 'n';
            } else if(dates[index].complete === 'n'){
                dates[index].complete = 'x';
            } else if(dates[index].complete === 'x'){
                dates[index].complete = 'y';
            }
            found = true;
        }
